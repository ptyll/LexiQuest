...
public class RegisterModelValidatorTests
{
    ...
    public RegisterModelValidatorTests()
    {
        ...
        localizer["Validation.Username.MinLength", 3].Returns(new LocalizedString("Validation.Username.MinLength", "Uživatelské jméno musí mít alespoň 3 znaky"));
        ...
        localizer["Validation.Username.MaxLength", 30].Returns(new LocalizedString("Validation.Username.MaxLength", "Uživatelské jméno může mít maximálně 30 znaků"));
        ...
        localizer["Validation.Password.MinLength", 8].Returns(new LocalizedString("Validation.Password.MinLength", "Heslo musí mít alespoň 8 znaků"));
    ...
    [Fact]
    public void RegisterModelValidator_LongEmail_ShowsError()
    {
        // Arrange
        var model = new RegisterModel
        {
            Email = new string('a', 250) + "@example.test",
            Username = "testuser",
            Password = "Strong1!Pass",
            ConfirmPassword = "Strong1!Pass",
            AcceptTerms = true
